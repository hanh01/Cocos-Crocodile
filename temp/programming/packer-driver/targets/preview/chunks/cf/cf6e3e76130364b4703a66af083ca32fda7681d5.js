          ...
          if (this.index != -1) {
            ...
            tween(this.tooth.getComponent(UITransform)).to((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
              ...
              contentSize: size((_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                error: Error()
              }), GameConfig) : GameConfig).TOOTH_SZIE.width, (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
                error: Error()
            ...
            console.log("2");
            this.tooth.getComponent(UITransform).contentSize = (_crd && GameConfig === void 0 ? (_reportPossibleCrUseOfGameConfig({
              error: Error()
            }), GameConfig) : GameConfig).TOOTH_SZIE;
          }

          console.log("size", this.tooth.getComponent(UITransform).contentSize);
        }
...
//# sourceMappingURL=cf6e3e76130364b4703a66af083ca32fda7681d5.js.map